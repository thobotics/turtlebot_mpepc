...
namespace navfn
{
	...
	NavfnROSExt::NavfnROSExt() : global_planner::GlobalPlanner() {}
	NavfnROSExt::NavfnROSExt(std::string name, costmap_2d::Costmap2D *costmap_ros, std::string frame_id) : global_planner::GlobalPlanner(name, costmap_ros, frame_id) {}
